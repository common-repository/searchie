...
class SIO_API_Files {
  /**
	...
	public function search( $args = [] ) 
	{
		$defaults = [
			'type' => 'search/files',
			'query_uri' => [
				'query' => $args['search'] . '&fields[]=title&include[]=tags&include[]=filePlaylists&page=1&status=processed',
				'page' => $args['paged']
			]
    	];
  ...
  public function get( $args= [] ) 
  {
    $defaults = [
		...
		'query_uri' => [
			'filter' => [
				'status_upload' => 'media_processed',
				'status_transcription' => 'transcription_processed',
				'status_transcode' => 'transcoding_processed',
			],
			'page' => $args['paged']
		]
    ];
	...
	public function getOptions() {
		...
		$get = SIO_MetaOption::get_instance()->files_data([
			'action' => 'r'
		]);
