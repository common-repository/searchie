...
class SIO_PageTemplate {
  ...
  /**
	...
	public function __construct() {
		...
		$this->templates = array(
			'full-width.php' => 'Searchie Full Width Page.',
		);
  ...
  /**
    ...
    $meta_template = get_post_meta(
			$post->ID, '_wp_page_template', true
		);

    $template_part = SIO_View::get_instance()->public_part_partials('templates/' . $meta_template);
